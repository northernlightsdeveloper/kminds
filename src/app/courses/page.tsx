        ...
        <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {subjectFilters.map((s) => (
              <button
                key={s}
                onClick={() => setActiveSubject(s as ActiveSubject)}
                className={`px-5 py-2 rounded-full font-headline text-label-md transition-all border ${
                  activeSubject === s
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {levelFilters.map((l) => (
              <button
                key={l}
                onClick={() => setActiveLevel(l as ActiveLevel)}
                className={`px-5 py-2 rounded-full font-headline text-label-md transition-all border ${
                  activeLevel === l
